...
deploy-mock:
	...
	cp test/mock.tf .; unset TF_CLI_ARGS_init; TF_VAR_MOCK=true TF_VAR_APP_NAME=swipe-test TF_VAR_BACK_ec2_instance_types='["optimal"]'; terraform init;  terraform apply --auto-approve
